...
BLOCK_SCHEDULE_ROW_MAJOR_SWIZZLE_8 = 18
BLOCK_SCHEDULE_ROW_MAJOR_SWIZZLE_19 = 19
BLOCK_SCHEDULE_ROW_MAJOR_SWIZZLE_38 = 20
BLOCK_SCHEDULE_BAND_N_8_ROW_MAJOR = 21
BLOCK_SCHEDULE_BAND_N_4_ROW_MAJOR = 22
BLOCK_SCHEDULE_BAND_N_2_ROW_MAJOR = 23
BLOCK_SCHEDULE_BAND_N_8_GROUPED_M_19 = 24
BLOCK_SCHEDULE_BAND_N_4_GROUPED_M_38 = 25
BLOCK_SCHEDULE_BAND_N_2_GROUPED_M_76 = 26
BLOCK_SCHEDULE_BAND_N_5_ROW_MAJOR = 27
BLOCK_SCHEDULE_BAND_N_10_ROW_MAJOR = 28
BLOCK_SCHEDULE_BAND_N_20_ROW_MAJOR = 29
BLOCK_SCHEDULE_BAND_N_20_GROUPED_M_4 = 30
BLOCK_SCHEDULE_BAND_N_20_GROUPED_M_8 = 31
BLOCK_SCHEDULE_BAND_N_20_GROUPED_M_16 = 32
...
BLOCK_SCHEDULE_STRATEGIES = {
    ...
    "row_major_swizzle_8": BLOCK_SCHEDULE_ROW_MAJOR_SWIZZLE_8,
    "row_major_swizzle_19": BLOCK_SCHEDULE_ROW_MAJOR_SWIZZLE_19,
    "row_major_swizzle_38": BLOCK_SCHEDULE_ROW_MAJOR_SWIZZLE_38,
    "band_n_8_row_major": BLOCK_SCHEDULE_BAND_N_8_ROW_MAJOR,
    "band_n_4_row_major": BLOCK_SCHEDULE_BAND_N_4_ROW_MAJOR,
    "band_n_2_row_major": BLOCK_SCHEDULE_BAND_N_2_ROW_MAJOR,
    "band_n_8_grouped_m_19": BLOCK_SCHEDULE_BAND_N_8_GROUPED_M_19,
    "band_n_4_grouped_m_38": BLOCK_SCHEDULE_BAND_N_4_GROUPED_M_38,
    "band_n_2_grouped_m_76": BLOCK_SCHEDULE_BAND_N_2_GROUPED_M_76,
    "band_n_5_row_major": BLOCK_SCHEDULE_BAND_N_5_ROW_MAJOR,
    "band_n_10_row_major": BLOCK_SCHEDULE_BAND_N_10_ROW_MAJOR,
    "band_n_20_row_major": BLOCK_SCHEDULE_BAND_N_20_ROW_MAJOR,
    "band_n_20_grouped_m_4": BLOCK_SCHEDULE_BAND_N_20_GROUPED_M_4,
    "band_n_20_grouped_m_8": BLOCK_SCHEDULE_BAND_N_20_GROUPED_M_8,
    "band_n_20_grouped_m_16": BLOCK_SCHEDULE_BAND_N_20_GROUPED_M_16,
}
...
@gluon.jit
def n_banded_grouped_launch(lin_idx, m_tiles, n_tiles, band_n: gl.constexpr, group_m: gl.constexpr):
    band_id = lin_idx // (m_tiles * band_n)
    within_band = lin_idx % (m_tiles * band_n)
    pid_m, pid_n_inner = grouped_launch(within_band, m_tiles, band_n, group_m, 0)
    return pid_m, band_id * band_n + pid_n_inner
...
def block_schedule_coords(
    ...
    if BLOCK_SCHEDULE_STRATEGY == 17:
        swizzled = xcd_swizzle(pid_mn, grid_m, GRID_N, 4)
        return swizzled % grid_m, swizzled // grid_m
    if BLOCK_SCHEDULE_STRATEGY == 18:
        swizzled = xcd_swizzle(pid_mn, grid_m, GRID_N, 8)
        return swizzled // GRID_N, swizzled % GRID_N
    if BLOCK_SCHEDULE_STRATEGY == 19:
        swizzled = xcd_swizzle(pid_mn, grid_m, GRID_N, 19)
        return swizzled // GRID_N, swizzled % GRID_N
    if BLOCK_SCHEDULE_STRATEGY == 20:
        swizzled = xcd_swizzle(pid_mn, grid_m, GRID_N, 38)
        return swizzled // GRID_N, swizzled % GRID_N
    if BLOCK_SCHEDULE_STRATEGY == 21:
        return n_banded_row_major(pid_mn, grid_m, GRID_N, 8)
    if BLOCK_SCHEDULE_STRATEGY == 22:
        return n_banded_row_major(pid_mn, grid_m, GRID_N, 4)
    if BLOCK_SCHEDULE_STRATEGY == 23:
        return n_banded_row_major(pid_mn, grid_m, GRID_N, 2)
    if BLOCK_SCHEDULE_STRATEGY == 24:
        return n_banded_grouped_launch(pid_mn, grid_m, GRID_N, 8, 19)
    if BLOCK_SCHEDULE_STRATEGY == 25:
        return n_banded_grouped_launch(pid_mn, grid_m, GRID_N, 4, 38)
    if BLOCK_SCHEDULE_STRATEGY == 26:
        return n_banded_grouped_launch(pid_mn, grid_m, GRID_N, 2, 76)
    if BLOCK_SCHEDULE_STRATEGY == 27:
        return n_banded_row_major(pid_mn, grid_m, GRID_N, 5)
    if BLOCK_SCHEDULE_STRATEGY == 28:
        return n_banded_row_major(pid_mn, grid_m, GRID_N, 10)
    if BLOCK_SCHEDULE_STRATEGY == 29:
        return n_banded_row_major(pid_mn, grid_m, GRID_N, 20)
    if BLOCK_SCHEDULE_STRATEGY == 30:
        return n_banded_grouped_launch(pid_mn, grid_m, GRID_N, 20, 4)
    if BLOCK_SCHEDULE_STRATEGY == 31:
        return n_banded_grouped_launch(pid_mn, grid_m, GRID_N, 20, 8)
    return n_banded_grouped_launch(pid_mn, grid_m, GRID_N, 20, 16)
