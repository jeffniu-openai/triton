...
- `direct_b_if_acc_first`, selector `0`, seed `22034`:
  `0/16384` mismatches, `4` PTX and LLIR scaled-MMA ops.
- `direct_b_if_acc_last_sel0`, selector `0`, seed `22025`:
  `0/16384`, `4` ops.
- `direct_b_if_acc_last_sel1`, selector `1`, seed `22026`:
  `0/16384`, `4` ops.
- `direct_b_helper_acc_last_sel1`, selector `1`, seed `22030`:
  `0/16384`, `4` ops.
- `direct_b_nested_acc_first`, selector `1`, seed `22039`:
  `0/16384`, `4` ops.
- `direct_b_helper_acc_first`, selector `1`, seed `22039`:
  `0/16384`, `4` ops.
- `direct_b_loop_acc_first`, selector `1`, seed `22037`:
  `0/16384`, `4` ops.
- `direct_a_if_acc_first`, selector `1`, seed `22035`:
  `0/16384`, `4` ops.
- `direct_both_if_acc_first`, selector `1`, seed `22038`:
  `0/16384`, `4` ops.
- `direct_b_if_two_mma`, selector `1`, seed `22064`:
  `0/16384`, `8` ops.

Existing `FZ-20260421-0013` scale descriptor-view rows:

| Case | Selector | Seed | Mismatches | Notes |
| --- | ---: | ---: | ---: | --- |
| `rtr_static_acc_first` | 0 | `22033` | `16374/16384` | scale descriptor view, `4` PTX/LLIR ops |
| `rtr_static_acc_last` | 0 | `22019` | `16368/16384` | scale descriptor view, `4` PTX/LLIR ops |
| `b_if_rtr_acc_first_sel0` | 0 | `22036` | `16373/16384` | branch-selected B-scale view |
| `b_if_rtr_acc_first` | 1 | `22032` | `16372/16384` | branch-selected B-scale view |
| `b_nested_rtr_acc_first` | 1 | `22036` | `16373/16384` | nested B-scale view |
| `both_if_rtr_acc_first` | 1 | `22035` | `16371/16384` | A-scale and B-scale views |
...
- `test_am_dynamic_bscale_descriptor_selection[0]`:
  seed `400`, `16381/16384` mismatches, NaN greatest difference.
- `test_am_dynamic_bscale_descriptor_selection[1]`:
  seed `401`, `16380/16384` mismatches, NaN greatest difference.

Passing controls:

- dynamic A-scale descriptor selection, selectors `0/1`, seeds `700/701`;
- dynamic B-scale same-object selection, selectors `0/1`, seeds `600/601`;
- branch-contained B-scale MMA, selectors `0/1`, seeds `800/801`;
...
- `test_am_scale_descriptor_view_chains[True-False]`:
  seed `210`, `16107/16384` mismatches.
- `test_am_scale_descriptor_view_chains[False-True]`:
  seed `201`, `16116/16384` mismatches.
- `test_am_scale_descriptor_view_chains[True-True]`:
  seed `211`, `16373/16384` mismatches.

Passing controls:

- direct A/B scale descriptors;
- accumulator subslice multi-MMA rows at slice starts `0` and `128`, seeds
  `300` and `428`;
