...
This file tracks TMEM-related ISA/API coverage work that is useful but not part
of the linear-layout generalization gap register. Items here should not consume
...
- Classification: ISA/API exposure follow-up, not a linear-layout gap.
- Closed baseline: signed i8 direct MMAv5 is supported on GB200/sm100 for the
